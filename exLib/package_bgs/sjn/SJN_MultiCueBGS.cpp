...
SJN_MultiCueBGS::SJN_MultiCueBGS() : firstTime(true), showOutput(false)
{
  //----------------------------------
  ...
  std::clog << "SJN_MultiCueBGS()" << std::endl;
}
...
{
  CvFileStorage* fs = cvOpenFileStorage("./config/SJN_MultiCueBGS.xml", 0, CV_STORAGE_WRITE);
...
{
  CvFileStorage* fs = cvOpenFileStorage("./config/SJN_MultiCueBGS.xml", 0, CV_STORAGE_READ);
